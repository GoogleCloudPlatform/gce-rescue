...
from gce_rescue.test.mocks import mock_api_object, MOCK_TEST_VM, MOCK_TEST_DATA
...
class RescueTest(absltest.TestCase):
    ...
    def test_instance(self):
        """Compare the properties values with the fixed values in
        instances.json.
        """
    ...
    def test_define_disks(self):
        """Validate the vm._define_disks() by comparing the function
        returned dict to MOCK_TEST_DATA.
        """
    ...
    def test_refresh_fingerprint(self):
        """Validate the refresh fingerprint function by resetting the
        value, calling the function and comparing the hearded code in
        instances.json.
        """
