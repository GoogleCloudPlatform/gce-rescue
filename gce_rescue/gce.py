...
def get_instance_info(
    ...
    """Set Dictionary with complete data from instances().get() from
    the instance.
    ...
    Attributes:
        ...
        project_data: dict, Dictionary containing project and zone keys
            to be unpacked when calling the API.
    """
...
def generate_ts() -> int:
    """Get the current timestamp to be used as unique ID during this
    execution.
    """
