...
"""Validations that should be performed before continue the script
execution. Each validations steps can be appended to the class
Validations() and keep the file under validations/ folder.
"""
...
from gce_rescue.tasks.validations.authentication import (authenticate_check,
    project_name)
